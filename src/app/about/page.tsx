                ...
                <div className="my-auto flex flex-col gap-3">
                    ...
                    <div className="flex flex-col gap-1">
                        <div className="text-lg sm:text-xl flex gap-1 font-semibold">
                            <img
                                src="/image/check.png"
                                className="w-4 h-4 sm:w-5 sm:h-5 mt-1.5 sm:mt-1"
                            />
                            프론트엔드 개발자를 희망합니다.
                        </div>
                        <div className="text-lg sm:text-xl flex gap-1 font-semibold">
                            ...
                            <div className="flex flex-col gap-4">
                                <div className="flex flex-col gap-1.5">
                                    ...
                                    <div className="ml-6 flex gap-1 text-base sm:text-lg">
                                        <img
                                            src="/image/check.png"
                                            className="w-3 h-3 sm:w-4 sm:h-4 mt-1.5 sm:mt-1"
                                        />
                                        바닐라 자바스크립트와 Express
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div className="ml-6 flex gap-1 text-base sm:text-lg">
                                <img
                                    ...
                                    className="w-3 h-3 sm:w-4 sm:h-4 mt-1.5 sm:mt-1"
                                />
                                각 코드에 따른 콜백 함수를 수집해 로직을
                                분리하는 handleResponse 헬퍼 함수를 작성하여
                                각종 예외를 처리하고 코드의 가독성을 높였습니다.
                            </div>
                        </div>
                    </div>
                </div>
